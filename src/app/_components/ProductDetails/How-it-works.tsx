  ...
  return (
    <div className='flex items-start gap-4' dir='rtl'>
      ...
      <div className='relative flex flex-col items-center shrink-0 self-stretch'>
        {/* Icon badge */}
        <span className='relative z-10 flex items-center justify-center size-12 rounded-full border border-brand-primary text-brand-primary bg-gray-50'>
          {icon}
        </span>
        {/* Connecting line — absolutely fills the space below the icon */}
        {!isLast && (
          <div className='absolute top-12 bottom-0 w-px bg-gray-300' />
        )}
      </div>
      {/* Text — pb controls the gap between steps, which the line fills */}
