...
export default function UsersReviews(data: any) {
  const owner = data.data.owner;
  const reviews = owner?.reviews ?? [];
                ...
                <div className='card-body p-4 justify-between'>
                  ...
                  <div className='flex items-center gap-2'>
                    <div className='avatar avatar-placeholder'>
                      <div className='bg-brand-primary text-neutral-content w-10 rounded-full flex items-center justify-center'>
                        <span>{initials}</span>
                      </div>
                    </div>
