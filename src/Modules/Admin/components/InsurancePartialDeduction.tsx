...
export default function InsurancePartialDeduction() {
  ...
  return (
    <div className="space-y-3 text-right">
      {/* قيمة الخصم input */}
      <div className="rounded-2xl border border-border-default px-4 py-3">
        <label
        ...
        <input
          ...
          placeholder="250"
          dir="rtl"
          className="mt-1 w-full border-none bg-transparent text-sm font-semibold text-text-primary placeholder-(--color-text-tertiary) outline-none"
        />
      </div>
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between rounded-xl border border-border-default px-4 py-2.5">
