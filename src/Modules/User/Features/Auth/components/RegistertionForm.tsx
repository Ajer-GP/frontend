...
import { z } from "zod";
import { signupSchema } from "../schemas/auth.validation";
import { registerAction } from "../services/actions";
// import { signupSchema } from "@/lib/validations/auth"; // adjust path
        ...
        <div>
          ...
          {errors.password ? (
            ...
            <p className="text-caption text-text-tertiary mt-1.5">
              كلمة السر لا تقل عن 8 أحرف وتحتوي على أرقام وحروف ورموز
            </p>
          )}
        </div>
